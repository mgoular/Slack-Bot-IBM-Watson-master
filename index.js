/ Script might deviate a little of the IBM original script.
/**
...
slackController.hears(['.*'],['direct_message', 'direct_mention', 'mention','message_received'], function(bot, message) {
